...
Game.MainMenu.prototype = {
   create:function(game) {
		...
		this.createButton(game,"About",game.world.centerX,game.world.centerY + 32, 300,100,
		function(){
			console.log('About');
		});
		
		title = game.add.sprite(game.world.centerX,game.world.centerY - 192,'titlescreen');
